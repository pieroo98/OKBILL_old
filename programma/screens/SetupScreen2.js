...
const AggiungiQuote = ({ spazio, item, setAddQuota, quoteMod, setQuoteMod, setCliccato, prezzo }) => {
    const handlePress = () => {
        let esporta = { persona: '1 quota', chiave: item.chiave, soldi: parseFloat(prezzo), bloccato: false, selezionato: true };
